...
a. Cloudflare (catch-all) → Gmail → Lambda #1 → S3 → Lambda #2 → OpenAI → Telegram → Lambda #3 → DynamoDB  
b. Users can:  
...
d. The delay from email arrival in Gmail to summary in Telegram is **up to 2 minutes**  
